...
// Paystack Plans >> fill in your own plan code & payment link
export const plans = [
    {
        link: process.env.NODE_ENV === 'development' ? 'https://paystack.com/pay/your_dev_payment_link' : '',
        priceId: process.env.NODE_ENV === 'development' ? 'your_dev_plan_code' :'',
        price: 19,
        duration: '/month'
    },
    {
    ...
    return (
        <>
            ...
            <section className="fixed right-8 bottom-8">
                <a
                    href="https://shipfa.st?ref=paystack_pricing_demo"
